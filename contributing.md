# Contribuir a Awesome Comunidad de Madrid
...
- El proyecto debe **dar soporte específico a la Comunidad de Madrid** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución madrileña** a la que el software da soporte (p.ej. comunidad.madrid, madrid.es, metro.madrid). Esto ayuda a verificar que el proyecto es relevante para la Comunidad de Madrid.
