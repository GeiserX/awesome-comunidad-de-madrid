...
- URL del repositorio
- URL del servicio/API/institución madrileña a la que da soporte (p.ej. comunidad.madrid, madrid.es, metro.madrid)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución madrileña |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Madrid, etc.)
Elimina esta sección si no aplica.
-->
