...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Comunidad de Madrid. No basta con que el autor sea de Comunidad de Madrid o resida aquí. Un framework genérico creado por un developer de Comunidad de Madrid no pertenece a esta lista. Un cliente para una API de servicios de Comunidad de Madrid sí.
